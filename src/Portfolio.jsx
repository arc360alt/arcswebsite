    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 text-gray-100">
      ...
      <div ref={aboutRef} id="about" className="pt-32 pb-16 px-8 text-center scroll-mt-24">
        <h1 className="text-5xl font-bold mb-3">
          hi! i'm <span className="bg-gradient-to-r from-purple-600 via-blue-600 to-blue-500 bg-clip-text text-transparent">Ark</span>
        </h1>
          ...
          <div className="bg-slate-800/40 backdrop-blur border border-slate-700/50 rounded-xl p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs bg-blue-500/20 text-blue-300 px-3 py-1 rounded-full">Intermediate</span>
              </div>
              <div className="flex items-center justify-between">
                <span>Python</span>
                <span className="text-xs bg-blue-500/20 text-blue-300 px-3 py-1 rounded-full">Intermediate</span>
      ...
      <div className="mx-auto px-8 mb-20" style={{ maxWidth: '620px' }}>
        <div className="bg-slate-800/60 backdrop-blur border border-slate-700/50 rounded-2xl overflow-hidden">
          ...
          <div 
            className="h-24"
            style={{
              backgroundImage: `url(https://cdn.discordapp.com/banners/719973177954140210/${discordData?.discord_user?.banner || '7658cb7ad9619ab92437d4e317012291'}.${discordData?.discord_user?.banner?.startsWith('a_') ? 'gif' : 'png'}?size=600)`,
          ...
          {filteredRepos.map((repo) => {
            ...
            return (
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`bg-slate-800/40 backdrop-blur border rounded-xl p-6 hover:scale-[1.02] transition-all duration-300 block ${
                  isCurrentSite 
                    ? 'border-blue-500/50 shadow-[0_0_30px_rgba(59,130,246,0.3)] hover:shadow-[0_0_40px_rgba(59,130,246,0.5)]' 
                    : 'border-slate-700/50 hover:border-blue-500/50 hover:shadow-[0_0_30px_rgba(59,130,246,0.3)]'
                }`}
              >
