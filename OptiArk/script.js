document.addEventListener('DOMContentLoaded', () => {
    ...
    const DOWNLOAD_DATA = {
        "Sodium": {
            "1.20.1 (Unsupported)": "https://github.com/arc360alt/OptiArk/releases/download/optiark-v1.8.0-plus1.20.1/OptiArk.1.20.1.1.8.Sodium.zip",
        ...
        "VulkanMod": {
            ...
            "1.21.4": "https://github.com/arc360alt/OptiArk/releases/download/optiark-v1.8.0-plus1.20.1/OptiArk.1.21.4.1.8.VK.zip",
            "1.21.5": "https://github.com/arc360alt/OptiArk/releases/download/optiark-v1.8.0-plus1.20.1/OptiArk.1.21.5.1.8.VK.zip"
        },
        "Nividium": {
            "1.20.1 (Unsupported)": "https://github.com/arc360alt/OptiArk/releases/download/optiark-v1.8.0-plus1.20.1/OptiArk.1.20.1.1.8.NV.zip",
